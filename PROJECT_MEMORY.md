...
- `cube4d2.html` lays navigation buttons in one vertical column in side-panel layouts and one horizontal row in portrait bottom-panel layouts, ordered up/forward/left/right/back/down.
- `cube4d2.html` status text omits cube-position mapping and shows compact move history as r/l/f/b/u/d letters without separators.
